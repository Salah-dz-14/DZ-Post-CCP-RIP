...
export const TRANSLATIONS: Record<Language, TranslationStrings> = {
  ar: {
    ...
    ccpInputLabel: 'رقم الحساب الجاري (CCP) — بدون المفتاح',
    ...
    placeholderCcp: 'أدخل رقم الحساب الجاري فقط بدون المفتاح (مثال: 12345678)',
  ...
  fr: {
    ...
    ccpInputLabel: 'Numéro de compte CCP (sans clé)',
    ...
    placeholderCcp: 'Entrez le numéro CCP sans clé (Ex: 12345678)',
  ...
  en: {
    ...
    ccpInputLabel: 'CCP Account Number (without key)',
    ...
    placeholderCcp: 'Enter CCP number without key (e.g. 12345678)',
